...
export const APARTMENTS = [
  {
    ...
    amenities_pl: ['Wifi', 'Klimatyzacja', 'Kuchnia', 'Winda', 'Pralka/Suszarka', 'Miejsce do pracy'],
    images: [
  ...
  },
  {
    ...
    amenities_pl: ['Widok na ogród', 'Patio', 'Wifi', 'Aneks kuchenny', 'Zwierzęta dozwolone', 'Ogrzewanie'],
    images: [
  ...
  },
  {
    ...
    amenities_pl: ['Łóżka piętrowe', 'Wolnostojąca wanna', 'Kuchnia Gourmet', 'Wifi', 'Smart TV', 'Przyjazny rodzinom', 'Pralka/Suszarka'],
    images: [
      'https://images.unsplash.com/photo-1616486029423-aaa478965c97?q=80&w=1200&auto=format&fit=crop',
      ...
      'https://images.unsplash.com/photo-1556912173-3db996ea8c3f?q=80&w=1200&auto=format&fit=crop',
  ...
  },
  {
    ...
    amenities_pl: ['Basen', 'Siłownia', 'Taras na dachu', 'Portier', 'Wifi', 'Smart TV', 'Klimatyzacja'],
    images: [
  ...
  },
  {
    ...
    amenities_pl: ['Wifi', 'Gramofon', 'Ekspres do kawy', 'Wanna', 'Suszarka do włosów', 'Ogrzewanie'],
    images: [
