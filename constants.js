...
export const APARTMENTS = [
  {
    ...
    images: ['https://picsum.photos/seed/apt1-main/1200/800'],
    beds: 1,
    baths: 1,
    guests: 2,
  ...
  },
  {
    ...
    description_pl: 'Ucieknij od hałasu w tym spokojnym studio z ogrodem.',
    amenities: ['Garden View', 'Patio'],
    images: ['https://picsum.photos/seed/apt2-garden/1200/800'],
    beds: 1,
    baths: 1,
    guests: 2,
    reviewsList: generateReviews(5)
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1616486029423-aaa478965c97?q=80&w=1200'],
    beds: 4,
    baths: 2,
    guests: 6,
    reviewsList: generateReviews(5)
  },
  {
    ...
    amenities: ['Pool', 'Gym'],
    images: ['https://picsum.photos/seed/apt4-skyline/1200/800'],
    beds: 2,
    baths: 2,
    guests: 4,
    reviewsList: generateReviews(5)
  },
  {
    ...
    description_pl: 'Zanurz się w kreatywności.',
    amenities: ['Wifi', 'Record Player'],
    images: ['https://picsum.photos/seed/apt5-art/1200/800'],
    beds: 1,
    baths: 1,
    guests: 2,
    reviewsList: generateReviews(5)
